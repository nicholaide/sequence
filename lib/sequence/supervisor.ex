defmodule Sequence.Supervisor do
  ...
  def start_link(initial_number) do
    result = {:ok, sup } = Supervisor.start_link(__MODULE__, [initial_number]) # this calls the init callback
  ...
  def start_workers(sup, initial_number) do
    ...
    {:ok, stash} = 
      Supervisor.start_child(sup, worker(Sequence.Stash,[ [initial_number | 1]] ))
